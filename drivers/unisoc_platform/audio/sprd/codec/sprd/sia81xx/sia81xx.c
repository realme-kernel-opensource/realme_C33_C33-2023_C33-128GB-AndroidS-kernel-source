...
static sia81xx_dev_t *g_default_sia_for_sprd = NULL;
...
void sia81xx_resume_for_sprd(void)
{
    if(g_default_sia_for_sprd) {
        sia81xx_resume(g_default_sia_for_sprd);
    }
}
EXPORT_SYMBOL(sia81xx_resume_for_sprd);
...
void sia81xx_suspend_for_sprd(void)
{
    if(g_default_sia_for_sprd) {
        sia81xx_suspend(g_default_sia_for_sprd);
    }
}
EXPORT_SYMBOL(sia81xx_suspend_for_sprd);
...
out:
    ...
    g_default_sia_for_sprd = sia81xx;
	return ret;

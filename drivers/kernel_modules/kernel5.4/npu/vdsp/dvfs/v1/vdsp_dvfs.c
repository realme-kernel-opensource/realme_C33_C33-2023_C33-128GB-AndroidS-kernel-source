...
static enum sprd_vdsp_kernel_power_level dvfs_recorrect_level(struct xvp *xvp, enum
							      ...
							      level);
static enum sprd_vdsp_kernel_power_level get_maxsupported_level(struct xvp
								*xvp);
...
static enum sprd_vdsp_kernel_power_level translate_powerlevel_fromuser(struct
								       xvp *xvp,
								       int32_t
								       in)
{
	...
	case 0:
		return dvfs_recorrect_level(xvp,

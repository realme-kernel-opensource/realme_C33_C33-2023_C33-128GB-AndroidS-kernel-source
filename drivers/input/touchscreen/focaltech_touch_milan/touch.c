...
EXPORT_SYMBOL_GPL(tp_interface);

int tp_headset_status = 0;
EXPORT_SYMBOL_GPL(tp_headset_status);

int tp_charge_status = 0;
EXPORT_SYMBOL_GPL(tp_charge_status);
...
EXPORT_SYMBOL_GPL(tp_charge_status_switch);
...
EXPORT_SYMBOL_GPL(tp_headset_status_switch);
...
EXPORT_SYMBOL_GPL(tp_create_sysfs);
...
EXPORT_SYMBOL_GPL(tp_remove_sysfs);
